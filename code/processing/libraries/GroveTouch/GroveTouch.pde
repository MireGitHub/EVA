         ...
         case("0"):  // PLAY and PAUSE
          ...
          case("2"):  // TEXT_INFO
               if( millis() - etaRead >= wait ){
                   ...
                   if( TEXT_ON_OFF == OFF) {
                      sendOscMessage(oscMapper+"text_file/1", pin);
                      TEXT_ON_OFF = ON;
                   }
                   else {
                      sendOscMessage(oscMapper+"text_file/0", pin);
                      TEXT_ON_OFF = OFF;
                   }
               }
               break;
